...
#include "algo/keccak/keccak-gate.h"
...
#include "algo/flex/cryptonote/cryptonight_dark.h"
#include "algo/flex/cryptonote/cryptonight_dark_lite.h"
#include "algo/flex/cryptonote/cryptonight_fast.h"
#include "algo/flex/cryptonote/cryptonight.h"
#include "algo/flex/cryptonote/cryptonight_lite.h"
#include "algo/flex/cryptonote/cryptonight_soft_shell.h"
#include "algo/flex/cryptonote/cryptonight_turtle.h"
#include "algo/flex/cryptonote/cryptonight_turtle_lite.h"
...
void flex_hash(void* output, const void* input) {
	...
	for (i = 0; i < 18; i++)
	{
		...
		switch(cnAlgo)
		{
		 case CNDark:
            //printf("... CNDark\n");
			cryptonightdark_hash(in, (void*)hash, size, 1);
			break;
		 case CNDarklite:
            //printf("... CNDarklite\n");
			cryptonightdarklite_hash(in, (void*)hash, size, 1);
			break;
		 case CNFast:
            //printf("... CNFast\n");
			cryptonightfast_hash(in, (void*)hash, size, 1);
			break;
		 case CNLite:
            //printf("... CNLite\n");
			cryptonightlite_hash(in, (void*)hash, size, 1);
			break;
		 case CNTurtle:
            //printf("... CNTurtle\n");
			cryptonightturtle_hash(in, (void*)hash, size, 1);
			break;
		 case CNTurtlelite:
            //printf("... CNTurtlelite\n");
			cryptonightturtlelite_hash(in, (void*)hash, size, 1);
			break;
		}
		//selection core algo
		switch (algo) {
